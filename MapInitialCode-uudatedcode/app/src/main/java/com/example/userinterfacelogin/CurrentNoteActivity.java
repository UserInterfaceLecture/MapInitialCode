...
import com.example.userinterfacelogin.databinding.ActivityCurrentnoteBinding;
...
public class CurrentNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCurrentnoteBinding binding = ActivityCurrentnoteBinding.inflate(getLayoutInflater());
